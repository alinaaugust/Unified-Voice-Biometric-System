...
def initParams():
    ...
    parser.add_argument("--sasv_dev_trial", type=str,
                        default="protocols/ASVspoof2019.PA.asv.dev.gi.trl.txt")
    parser.add_argument("--sasv_eval_trial", type=str,
                        default="protocols/ASVspoof2019.PA.asv.eval.gi.trl.txt")
    parser.add_argument("--cm_trn_list", type=str,
                        default="protocols/ASVspoof2019.PA.cm.train.trn.txt")
    parser.add_argument("--cm_dev_list", type=str,
                        default="protocols/ASVspoof2019.PA.cm.dev.trl.txt")
    parser.add_argument("--cm_eval_list", type=str,
                        default="protocols/ASVspoof2019.PA.cm.eval.trl.txt")
...
def train(args):
    if "pr" in args.model_name:
        ...
        model = Baseline1()
    elif args.model_name == "casc_asv_cm":
        model = Cascade(first='asv')
